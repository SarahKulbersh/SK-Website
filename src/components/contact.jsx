...
import { MDBBtn, MDBCard, MDBCardBody, MDBCardImage, MDBCol, MDBInput, MDBRow, MDBTypography, MDBTextArea } from 'mdb-react-ui-kit';
                            ...
                            <MDBCard className="my-4 shadow-3" style={{ backgroundColor: 'black' }}>
                                <MDBRow className="g-0">
                                    <MDBCol md="6" className="d-xl-block bg-image">
                                        <MDBCardImage src={bg} alt="Sample photo" fluid style={{ width: '100%', height: '100%', minHeight: '330px' }} />
                                                    ...
                                                    <figure className="text-center mb-0" >
                                                        <blockquote className="whitequote text-white" >
                                                            <p className="pb-3" style={{ marginTop: '-50px' }}>
                                                                <span className="lead font-italic" style={{ fontFamily: 'dosis-medium', fontSize: '30px' }}>Let's get in touch</span>
                                                            </p>
                                                            <div className='contactinfo' style={{ justifyContent: 'center', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', width: '70%' }} >
                                    ...
                                    <MDBCol md="6" style={{ backgroundColor: '#D59B33' }}>
                                        <MDBCardBody className="p-md-5 text-black" >
                                            <MDBTypography className="mb-4 " style={{ color: 'white', alignItems: 'center', fontFamily: 'dosis-medium', fontSize: '30px' }}>Get in touch</MDBTypography>
